...
// SonataFlowPlatformRef defines the desired state of SonataFlowClusterPlatform
type SonataFlowPlatformRef struct {
	//+operator-sdk:csv:customresourcedefinitions:type=status,displayName="platformName"
	Name string `json:"name"`
	//+operator-sdk:csv:customresourcedefinitions:type=status,displayName="platformNamespace"
...
func (in *SonataFlowClusterPlatformStatus) IsCreating() bool {
	cond := in.GetTopLevelCondition()
	return cond.IsFalse() && cond.Reason == PlatformCreatingReason
}

func (in *SonataFlowClusterPlatformStatus) IsWarming() bool {
	cond := in.GetTopLevelCondition()
...
func (in *SonataFlowClusterPlatformStatus) IsFailure() bool {
	cond := in.GetTopLevelCondition()
